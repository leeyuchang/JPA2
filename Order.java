...
public class Order {
  ...
  /**
   * Helper mathods for 2way references
   * @param member
   */
  ...
  public void cancel() {
    ...
    if (!isCancelable()) {
      throw new RuntimeException("Unable to cancel this order because of delivery having done");
    }
  ...
  private boolean isCancelable() {
    return delivery.getStatus().equals(DeliveryStatus.READY) ? true : false;
  }
